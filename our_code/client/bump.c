...
CORO_CONTEXT( position_sender);

/* coro position sender define */
CORO_DEFINE( position_sender) {
	CORO_LOCAL int  val;
	...
	CORO_CALL( position_sender);
		...
		get_tacho_max_speed( sn, &max_speed );
               ...
               /* set_tacho_stop_action_inx( sn, TACHO_COAST );
                ...
                get_tacho_count_per_rot(sn,&val);
